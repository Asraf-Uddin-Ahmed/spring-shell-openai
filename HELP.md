...
* The original package name 'com.asraf.spring-shell-openai' is invalid and this project uses 'com.asraf.springshellopenai' instead.
...
```
$ docker run --rm spring-shell-openai:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-shell-openai
```
